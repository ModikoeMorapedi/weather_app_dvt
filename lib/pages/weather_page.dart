          ...
          ? Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(StringsUtil.loading, style: textStyleBoldWhite36),
                ],
              ),
            )
          : Column(
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(StringsUtil.min, style: textStyleNormalWhite16),
                        Text(StringsUtil.current,
                            style: textStyleNormalWhite16),
                        Text(StringsUtil.max, style: textStyleNormalWhite16),
                      ],
                    ),
                  ]),
                ),
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child:
                                            Image.asset(weatherViewModel.icon!),
                                      ),
                                    ),
                                    Container(
                                      alignment: Alignment.center,
